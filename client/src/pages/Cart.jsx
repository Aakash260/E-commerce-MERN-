                ...
                <div className='my-2 w-[20vw]'>
                  {
                    !clientToken || !cart?.length ? ("") : <>
                      ...
                      />
                      <button disabled={loading || !instance || !auth?.user?.address} onClick={handlePayment} className="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">{loading ? 'Processing...':'Make Payment'}</button>
                    </>
                  }
