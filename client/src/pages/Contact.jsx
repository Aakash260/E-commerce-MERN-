  ...
  <div className="container px-6 py-12 mx-auto">
    ...
    <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
      <div>
        ...
        <p className="mt-2 text-blue-500 dark:text-blue-400">akashnirwan26@gmail.com</p>
      </div>
      <div>
        <span className="inline-block p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
        ...
        <p className="mt-2 text-blue-500 dark:text-blue-400">100 SouthDelhi Andehere Nageri</p>
      </div>
      <div>
        <span className="inline-block p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
        ...
        <p className="mt-2 text-blue-500 dark:text-blue-400">8447276004</p>
      </div>
    </div>
  </div>
</section>
